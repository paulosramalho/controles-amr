              ...
              {filtered.map((c) => {
                ...
                return (
                  <tr key={c.id} className="bg-white">
                    ...
                    <td className="px-4 py-3 text-slate-800 whitespace-nowrap">R$ {formatBRLFromDecimal(p.valorRecebido)}</td>
                    <td className="px-4 py-3 text-slate-800 whitespace-nowrap">R$ {formatBRLFromDecimal(c.valorTotal - (p.valorRecebido || 0))}</td>
